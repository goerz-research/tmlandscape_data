...
from notebook_utils  import get_stage2_table, get_stage3_table
from mgplottools.mpl import new_figure, set_axis

STYLE = 'poster.mplstyle'
...
OUTFOLDER = '/Users/goerz/Documents/Presentations/2015-09-30_UMD_tmlandscape/Poster/images'
...
def generate_error_plot(outfile):
    ...
    # gate duration [ns]
    10                       7.54e-04           2.91e-04                5.15e-04
    20                       1.51e-03           9.93e-04                1.15e-03
    ...
    ax.legend(loc=2)
    set_axis(ax, 'x', 0, 200, 50, minor=5, label='gate time (ns)')
...
def main(argv=None):
    ...
    generate_map_plot(get_stage2_table('./runs_010_RWA'), T=10,  outfile='map_010.png')
    ...
    generate_weyl_plot(get_stage2_table('./runs_010_RWA'), outfile='weyl_010.pdf')
    generate_error_plot(outfile='errors.pdf')
